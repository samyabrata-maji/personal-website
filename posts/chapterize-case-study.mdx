...
description: Chapterize is a simple NextJS website that generates youtube chapters from a youtube video. It uses OpenAI's gpt-3.5-turbo model to analyze the transcripts of the videos and generate chapters based on that.
keywords: chapterize, gpt3, ai
created: 2023-08-19
---

[Chapterize](https://chapterize.vercel.app/) is a simple NextJS website that generates youtube chapters from a youtube video. It uses OpenAI's _gpt-3.5-turbo_ model to analyze the transcripts of the videos and generate chapters based on that.
